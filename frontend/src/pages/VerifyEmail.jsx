  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F7F9FC] text-[#0F172A] p-6">
      <form onSubmit={submit} className="w-full max-w-md card-surface p-8" data-testid="verify-form">
        ...
        <p className="text-[#64748B] text-sm mb-6">E-postanıza gönderilen 6 haneli kodu girin</p>
        ...
        <label className="text-xs text-[#64748B]">Kod</label>
        ...
        <button type="button" onClick={resend} className="w-full mt-3 text-xs text-[#16A34A] hover:underline" data-testid="verify-resend">
          Kodu tekrar gönder
        </button>
        <div className="text-xs text-[#64748B] mt-5 text-center">
          <Link to="/dashboard" className="hover:text-[#0F172A]">Şimdilik atla</Link>
        </div>
      </form>
    </div>
  );
